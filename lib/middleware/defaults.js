...
var defaultsMiddleware = module.exports = function( req, res, next ){
  ...
  if( res.locals.currentUser && res.locals.currentUser.preferences && res.locals.currentUser.preferences.common && res.locals.currentUser.preferences.common.culture )
    culture = res.locals.currentUser.preferences.culture
